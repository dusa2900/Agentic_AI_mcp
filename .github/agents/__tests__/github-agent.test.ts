import { GitHubMCPAgent, createGitHubAgent } from '../github-agent-client';
import * as githubTools from '../../../backend/src/mcp/github/github.tools';

// Mock the github tools module
jest.mock('../../../backend/src/mcp/github/github.tools');
